...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      outline: 'border-2 border-border-default bg-transparent text-text-primary hover:bg-background focus:ring-primary',
      ghost: 'bg-transparent text-text-primary hover:bg-background focus:ring-primary',
    };
