...
import { ArrowRight, Star, Shield, Heart, Users, ChevronDown, ChevronUp, Check } from 'lucide-react';
...
export default function GenieForHerPage() {
  ...
  const fetchProductReviews = async () => {
    try {
      const response = await getProductReviews('genie-for-her');
  ...
  const product = {
    name: 'Genie for Her',
    tagline: 'Empower Your Wellness & Vitality',
    rating: reviewStats.averageRating || 4.9,
    reviewCount: reviewStats.totalReviews || 0,
    images: [
      '/images/products/genie-for-her/genie-for-her-1.webp',
      '/images/products/genie-for-her/genie-for-her-2.webp',
      '/images/products/genie-for-her/genie-for-her-3.webp',
      '/images/products/genie-for-her/genie-for-her-4.webp',
      '/images/products/genie-for-her/genie-for-her-5.webp'
    ],
    singlePrice: 10,
    packPrice: 99,
    packSize: 12
  ...
  const ingredients = [
    { name: 'Damiana Leaf', benefit: 'Traditional female wellness support' },
    { name: 'Maca Root', benefit: 'Natural energy and vitality booster' },
    { name: 'Ginkgo Biloba', benefit: 'Circulation and mental clarity' },
    { name: 'Red Clover', benefit: 'Hormonal balance support' },
  ...
  const faqs = [
    {
      question: 'How is this different from the male formula?',
      answer: 'Genie for Her is specifically formulated with ingredients that support female wellness and hormonal balance. Our blend focuses on natural vitality enhancement tailored to women\'s unique physiology.'
    },
    {
      question: 'Is it safe during menstruation?',
      answer: 'Yes, Genie for Her is safe to use during menstruation. However, if you have specific health concerns or conditions, we recommend consulting with your healthcare provider.'
    },
    {
      question: 'How long do the effects last?',
      answer: 'Effects typically last 4-6 hours, though individual experiences may vary. The natural ingredients work with your body\'s systems for sustained wellness support.'
    },
    {
      question: 'Can I use this with other supplements?',
      answer: 'Genie for Her is made with natural ingredients and is generally safe to use with other supplements. However, we recommend consulting your healthcare provider about any potential interactions.'
    }
  ];
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-text-secondary mb-8">
          ...
          <span>/</span>
          <span className="text-text-primary">Genie for Her</span>
        </nav>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-secondary text-white py-4 rounded-lg font-semibold hover:bg-secondary/90 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {showSuccess ? (
                  <>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-border-default">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-text-primary">Made for Women</p>
              </div>
              <div className="text-center">
            ...
            {activeTab === 'description' && (
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-text-secondary mb-6">
                  Genie for Her is thoughtfully formulated to support female vitality and wellness. 
                  Our unique blend of natural ingredients has been carefully selected to enhance 
                  energy, confidence, and overall well-being for the modern woman.
                </p>
                <h4 className="font-semibold text-text-primary mb-3">Key Benefits:</h4>
                <ul className="space-y-2 text-text-secondary">
                  <li>• Enhanced natural energy and vitality</li>
                  <li>• Improved confidence and mood</li>
                  <li>• Support for hormonal balance</li>
                  <li>• Fast-acting natural formula</li>
                ...
                <p className="text-text-secondary">
                  ...
                  Do not exceed one bottle per day. Can be taken with or without food.
                </p>
                <div className="mt-6 p-4 bg-secondary/10 rounded-lg border border-secondary/20">
                  <h4 className="font-semibold text-text-primary mb-2">Empowering Women</h4>
                  <p className="text-text-secondary">
                    We believe every woman deserves to feel confident and empowered in her wellness journey. 
                    Genie for Her is designed to support your natural vitality and help you feel your best.
                  </p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'ingredients' && (
              <div>
                ...
                <div className="mt-8 p-6 bg-secondary/5 rounded-lg border border-secondary/20">
                  <h4 className="font-semibold text-text-primary mb-2">Quality & Purity</h4>
                  <p className="text-text-secondary">
                    Every ingredient is carefully sourced and tested for purity and potency. 
                    Our female-focused formula is developed with women's unique physiology in mind, 
